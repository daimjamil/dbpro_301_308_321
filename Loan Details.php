...
<div id="InsertBox">
      <div class="center">
        ...
        <form action="loandetailsdb.php" method="post">
		...
		<div class="form-group">
			...
			<input type="text" name="loantype" class="form-control" required placeholder="Loan Type">
			</div>
        <div class="form-group">
			
			<input type="text" name="interest" class="form-control" required placeholder="Interest">
			</div>
