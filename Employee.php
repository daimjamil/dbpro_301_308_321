...
<div id="InsertBox">
      <div class="center">
		...
		<div class="form-group">
			...
			<input type="text" name="employeename" class="form-control" required placeholder="Employee Name">
			</div>
		<div class="form-group">
			
			<input type="text" name="employeecnic" class="form-control" required placeholder="Employee CNIC">
			</div>
        <div class="form-group">
			
			<input type="text" name="employeephone" class="form-control" required placeholder="Employee Phone#">
			</div>
        <div class="form-group">
			
			<input type="text" name="employeeaddress" class="form-control" required placeholder="Employee Address">
			</div>
